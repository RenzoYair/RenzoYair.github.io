...
<html lang="en" class="no-focus"> 
        ...
        <title> PEDRO P. DIAZ - ACCESO MESA DE PARTES</title>
    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            <main id="main-container">
                <div class="bg-image" style="background-image: url('public/assets/img/photos/fotopedro.jpg');">
                    <div class="row mx-0 bg-black-op">
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            <div class="p-30 invisible" data-toggle="appear">
                                <p class="font-size-h3 font-w600 text-white">
                                    MESA DE PARTES - BIENVENIDO
                                </p>
                                <p class="font-italic text-white-op">
                                    MESA DE PARTES - LENGUAJE DE PROGRAMACION &copy; <span class="js-year-copy">R.C.</span>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="content content-full">
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="https://iestp-ppd.edu.pe/">
                                        <span class="font-size-xl text-primary-dark">PAGINAPRINCIPAL</span><span class="font-size-xl">PEDRO P. DIAZ</span>
                                    </a>
                                    <h1 class="h3 font-w700 mt-30 mb-10">INSTITUTO SUPERIOR PEDRO P. DIAZ</h1>
                                    <h2 class="h5 font-w400 text-muted mb-0">IDENTIFICATE</h2>
                                </div>
